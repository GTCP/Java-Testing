 ...
 * Se trata de una serie de tareas ejecutadas en determinados horarios.
 *
...
public class Programa {
     ...
     * @throws ProgramacionNoEncontradaFoundException 
     * Si no existe esa programaci'on dentro del programa.
     */
    public void removeProgramacion(Programacion p) throws ProgramacionNoEncontradaExcepcion {
        if (!_items.remove(p)) {
            throw new ProgramacionNoEncontradaExcepcion();
        }
    }
